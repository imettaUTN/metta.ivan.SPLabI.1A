...
/** \brief transforma un elemento de la lista segun una funcion dada
 *
 * \param this LinkedList* Puntero a la lista punteor a la lista
 * \param element void* (*pFunc) funcion que transforma el elemento de la lista
 * \return nueva lista puntero a nueva lista
 *
 */
